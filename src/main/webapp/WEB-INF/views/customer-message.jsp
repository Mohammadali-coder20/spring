...
<c:url var="firstUrl" value="/admin/customer-message/1"/>
<c:url var="lastUrl" value="/admin/customer-messages/${totalPages}"/>
<c:url var="prevUrl" value="/admin/customer-messages/${currentPageNumber - 1}"/>
<c:url var="nextUrl" value="/admin/customer-messages/${currentPageNumber + 1}"/>
            ...
            <div class="container">
                ...
                <c:forEach var="contact" items="${customerContacts}">
                    ...
                    <div class="row message">
                        ...
                        <form action="<c:url value="/admin/customer-message/delete-message" />" method="post"
