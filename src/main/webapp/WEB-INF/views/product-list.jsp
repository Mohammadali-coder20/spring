             ...
             <div class="col-md-3">
		            <h1 class="Product-category">Product Category</h1>
		             <div class="list-group popular-product">
		                        ...
		                        <a href="<c:url  value="/product/product-list/DvdPlayer/1"/>" class="list-group-item">DVD PLayer</a>
		                        <a href="<c:url  value="/product/product-list/Fan/1"/>" class="list-group-item">Fan</a>
             ...
             <div class="product-single">
                <div class=" text-center productColumn">
                 <div class=" img-responsive productImage">
					 <img  style="width:50%; height: 50%  "  alt="image" src="/product/rest/get-img/${product.productID}" />
                 </div>
